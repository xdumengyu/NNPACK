...
static NNP_INLINE void winograd_f6k3_input_transform_inplace(
	float32x4_t q0[restrict static 1],
	float32x4_t q1[restrict static 1],
	float32x4_t q2[restrict static 1],
	float32x4_t q3[restrict static 1],
	float32x4_t q4[restrict static 1],
	float32x4_t q5[restrict static 1],
	float32x4_t q6[restrict static 1],
	float32x4_t q7[restrict static 1])
{
